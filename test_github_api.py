...
def test_get_file_diffs_in_pull_request(owner, repo, pull_request_number):
    print("Testing: Get File Diffs in Pull Request")
    response = get_file_diffs_in_pull_request(owner, repo, pull_request_number)
    for file, diff in response.items():
        print(f'File: {file}')
        print(f'Diff: {diff}')
...
if __name__ == '__main__':
    ...
    # test_get_file_diffs_in_pull_request(owner, repo, pull_request_number)
